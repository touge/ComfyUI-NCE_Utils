...
from ...facelib.utils import load_file_from_url, download_pretrained_models
...
# print(f"facedetection_model_dir:{facedetection_model_dir}")
...
def init_retinaface_model(model_name, half=False, device='cuda'):
    ...
    model_path = load_file_from_url(url=model_url, model_dir = facedetection_model_dir, progress=True, file_name=None)
